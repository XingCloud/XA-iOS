...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [XA trackPayService:@"transID" channel:@"appStore" gross:@"100" gcurrency:@"US" vamount:@"10" vcurrentcy:@"ni"];
    [XA trackTutorialService:@"3"  name:@"go" tutorial:@"to"];
    [XA event:USER_LOGIN appId:@"a123" userId:@"hello" timestamp:222222222 params:@"null"];
    return YES;
}
							
- (void)applicationWillResignActive:(UIApplication *)application
{
    [XA applicationWillResignActive];
    /*
